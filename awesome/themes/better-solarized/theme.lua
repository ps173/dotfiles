--[[
     ...
     Good-Solatized Awesome WM theme 2.0 (Modified from rainbow)
     Modified by - github.com/ps173
...
theme.fg_focus                                  = "#fca311"
theme.bg_normal                                 = "#14213d"
theme.bg_focus                                  = "#0E515E"
theme.fg_urgent                                 = "#000000"
theme.bg_urgent                                 = "#FFFFFF"
theme.border_width                              = dpi(1)
theme.border_normal                             = "#fca311"
theme.border_focus                              = "#fca311"
theme.taglist_fg_focus                          = "#16C7C7"
theme.taglist_bg_focus                          = "#14213d"
theme.menu_height                               = dpi(16)
theme.menu_width                                = dpi(140)
theme.ocol                                      = "<span background-color='".. theme.bg_normal .."' color='" .. theme.fg_normal .. "'>"
...
-- Textclock
local mytextclock = wibox.widget.textclock(markup("#22C3CD", " %I:%M "))
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(25), bg = theme.bg_normal, fg = theme.fg_normal, border_width=dpi(5) })
