" Modified by : Pratham Sharma <prathamsharma173@gmail.com>
" Version: 0.1.0
" License: MIT
"
" Original Theme by : Jamie Dumont <jamiedumont@icloud.com>
...
" Base colors.
let s:colors.base0 = { 'gui': '#363636', 'cterm': 0 }
let s:colors.base1 = { 'gui': '#363636', 'cterm': 8 }
let s:colors.base2 = { 'gui': '#272A2A', 'cterm': 10 }
let s:colors.base3 = { 'gui': '#515257', 'cterm': 12 }
let s:colors.base4 = { 'gui': '#1e6479', 'cterm': 11 }
let s:colors.base5 = { 'gui': '#2f9696', 'cterm': 14 }
let s:colors.base6 = { 'gui': '#99d1ce', 'cterm': 7 }
let s:colors.base7 = { 'gui': '#d3ebe9', 'cterm': 15 }

" Other colors.
let s:colors.red     = { 'gui': '#D55249', 'cterm': 1  }
let s:colors.orange  = { 'gui': '#CC7044', 'cterm': 9  }
let s:colors.yellow  = { 'gui': '#F6B83E', 'cterm': 3  }
let s:colors.magenta = { 'gui': '#846291', 'cterm': 13 }
let s:colors.violet  = { 'gui': '#3F4468', 'cterm': 5  }
let s:colors.blue    = { 'gui': '#63778A', 'cterm': 4  }
...
" Plugin =======================================================================
" Telescope
" TODO : Add telescope support

" BAR BAR 
" Add bufferline color support
